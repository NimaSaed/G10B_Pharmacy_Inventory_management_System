...
<table align= "center">
  ...
  <tr>
    <td width="280" height="30" align="center" valign="middle" bgcolor="#333333" style="border-top-left-radius:10px; font-family:Verdana, Geneva, sans-serif; font-size:12px; font-weight:bold; color:#FFFFFF">Medicine ID</td>
    ...
    <td width="280" height="30" align="center" valign="middle" bgcolor="#333333" style="font-family:Verdana, Geneva, sans-serif; font-size:12px; font-weight:bold; color:#FFFFFF">Quantitiy</td>
...
<?php
	...
	if($input=="")
	{
		echo"<p><h3>Input in search Medicine ID or Name </h3>";
		exit;
	
		

	$sql2 = "select * from stock where stock_id LIKE '%$input%' OR drug_name LIKE '%$input%'";
	$result2 = mysql_query($sql2) or die("Unavailable in database");
	}
