...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2016 at 08:39 AM
...
INSERT INTO `pharmacist` (`pharmacist_id`, `first_name`, `last_name`, `staff_id`, `postal_address`, `phone`, `email`, `username`, `date`, `password`) VALUES
(1, 'kanimozhi', 'nalllathamby', 'Pharmacy2', '55100', '0909090909', 'kani@pharmacysys.com', 'kani', '2016-02-11 03:01:00', '1234'),
(2, 'magdelene', 'william', '2', '55100', '08080808', 'mag@pharmacysys.com', 'mag', '2016-02-11 10:00:00', '1234'),
(4, 'cavin', 'miachael', '4', '55100', '0303030303', 'cav@pharmacysys.com', 'cavin', '2016-02-11 11:00:00', '1234'),
(5, 'dharma', 'seelan', 'Pharmacy1', '55100', '0789653412', 'd@pharmacysys.com', 'dharma', '2016-02-11 05:18:51', '1234');
...
--
-- Table structure for table `soldmedic`
--

CREATE TABLE `soldmedic` (
...
CREATE TABLE `stock` (
  ...
  `frequentlysold` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `stock` (`stock_id`, `drug_name`, `category`, `description`, `company`, `supplier`, `quantity`, `cost`, `status`, `date_supplied`, `sold`, `sales`, `frequentlysold`) VALUES
(5, 'Piriton', 'tablet', 'Painkiller', 'SB', 'SB', 1000, 5, 'Available', '2013-11-30', 0, 'dailysales', 'yes'),
(6, 'Dual Cotexin', 'tablet', 'Malaria', 'GX', 'Clinix', 150, 120, 'Available', '2013-11-30', 0, 'dailysales', 'no'),
(7, 'Naproxen', 'Tablet', 'Reproductive', 'Family Health', 'Stopes', 250, 250, 'Available', '2013-11-30', 0, 'Monthlysales', 'no'),
(8, 'Flagi', 'talet', 'Digestive', 'GX', 'Clinix', 657, 15, 'Available', '2013-11-30', 0, 'monthlysales', 'no'),
(9, 'Actal', 'Tablet', 'Stomach Reliev', 'GX', 'Clinix', 1000, 1, 'Available', '2013-12-06', 0, 'Monthlysales', 'yes'),
(10, 'Paracetamol', 'tablet', 'treats fever', 'Panadol', 'Panadol', 1000, 3, 'Available', '2016-02-11', 0, 'dailysales', 'yes');
